...
require_relative "lib/http_roundtrip/version"

Gem::Specification.new do |spec|
  spec.name          = "http_roundtrip"
  spec.version       = HttpRoundtrip::VERSION
  spec.authors       = ["Tristan Sloughter"]
  spec.email         = ["tsloughter+work@splunk.com"]

  spec.summary       = "Simple HTTP example of using the Splunk OpenTelemetry Ruby distro"
  spec.description   = "Simple HTTP example of using the Splunk OpenTelemetry Ruby distro"
